...
before packages are loaded."
  ...
  (setq org-todo-keywords
        (quote ((sequence "NEXT(n)" "TODO(t)" "|" "DONE(d)")
                (sequence "WAITING(w@/!)" "REVIEW(r@/!)" "RELEASE PENDING(p)" "|" "CANCELLED(c@/!)"))))
  ...
  (setq default-nix-wrapper
        (lambda (args)
          (append
           (append (list "nix-shell" "-I" "ssh-config-file=/home/sam/.ssh/nixbuild.config" "--pure" "--command" )
  ...
  (evil-leader/set-key-for-mode 'haskell-mode "hb" 'lsp-describe-thing-at-point)
  ...
  (add-to-list 'org-refile-targets `(,(org-file-path "index.org") :maxlevel . 4))
  ...
  (evil-leader/set-key "oi" 'sep/open-inbox-file)
  (evil-leader/set-key "ot" 'sep/open-index-file)
  ...
  ;; save file after creating it
  (setq org-archive-location (concat "/home/sam/org/archive/"
